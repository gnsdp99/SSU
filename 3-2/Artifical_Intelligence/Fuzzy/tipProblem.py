...
serv_lo = fuzz.gaussmf(x_serv, 0.0, 2.0)
serv_md = fuzz.gaussmf(x_serv, 5.0, 2.0)
serv_hi = fuzz.gaussmf(x_serv, 10.0, 2.0)
tip_lo = fuzz.gaussmf(x_tip, 0.0, 5.0)
tip_md = fuzz.gaussmf(x_tip, 13.0, 5.0)
tip_hi = fuzz.gaussmf(x_tip, 26.0, 5.0)
